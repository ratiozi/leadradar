$headers = @{
    ...
    "X-Skip-Source-Snapshot" = "deploy from GitHub Release"
}

$deployBody = @"
{
  "source": { "url": "https://github.com/ratiozi/leadradar/releases/download/v1/leadradar-v1.zip" },
  "runtime": "node20",
  "install": "cd /opt/app/leadradar-v1 && npm install --production",
  "start": "cd /opt/app/leadradar-v1/backend && node server.js",
  "port": 3000,
  ...
  "extractTo": "/opt/app/leadradar-v1",
  "systemd": true
}
"@
