$headers = @{
    ...
    "X-Skip-Source-Snapshot" = "redeploy with fixed install path"
}
...
$deployBody = @"
{
  ...
  "runtime": "node20",
  "install": "cd /opt/app/backend && npm install --production",
  "start": "cd /opt/app/backend && node server.js",
  "port": 3000,
  "displayName": "LeadRadar — Аналитика лидов",
  "description": "Дашборд для визуализации и аналитики лидов из Битрикс24. 15 метрик, графики динамики, UTM-аналитика. Обновление: исправлен путь установки зависимостей.",
  "extractTo": "/opt/app",
  "systemd": true
}
"@
